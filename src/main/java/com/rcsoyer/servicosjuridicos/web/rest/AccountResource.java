...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody final ManagedUserVM managedUserVM) {
    ...
    @Timed
    @PostMapping("/account")
    public void saveAccount(@Validated(UserView.Create.class) @RequestBody UserDTO userDTO) {
