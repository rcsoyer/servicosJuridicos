...
@Component({
    selector: 'jhi-ferias-licenca',
    templateUrl: './ferias-licenca.component.html'
})
export class FeriasLicencaComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/ferias-licenca'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInFeriasLicencas();
    }
    ...
    registerChangeInFeriasLicencas() {
        this.eventSubscriber = this.eventManager.subscribe('feriasLicencaListModification', response => this.loadAll());
    }
