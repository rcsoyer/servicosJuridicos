...
@Component({
    selector: 'jhi-advogado-dg-coordenacao',
    templateUrl: './advogado-dg-coordenacao.component.html'
})
export class AdvogadoDgCoordenacaoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.advogadoDgCoordenacaoService
            .query({
                page: this.page - 1,
    ...
    transition() {
        this.router.navigate(['/advogado-dg-coordenacao'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    ngOnInit() {
        ...
        this.registerChangeInAdvogadoDgCoordenacaos();
    }
    ...
    registerChangeInAdvogadoDgCoordenacaos() {
        this.eventSubscriber = this.eventManager.subscribe('advogadoDgCoordenacaoListModification', response => this.loadAll());
    }
    ...
    private paginateAdvogadoDgCoordenacaos(data: AdvogadoDgCoordenacao[], headers: HttpHeaders) {
        ...
        this.advogadoDgCoordenacaos = data;
    }
