    ...
    describe('Modalidade Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/modalidades';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Modalidade', () => {
                service.create(new Modalidade(null)).subscribe(received => {
            ...
            it('should update a Modalidade', () => {
                service.update(new Modalidade(123)).subscribe(received => {
