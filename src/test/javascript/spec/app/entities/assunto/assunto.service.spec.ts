...
describe('Service Tests', () => {
    describe('Assunto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssuntoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/assuntos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Assunto', () => {
                service.create(new Assunto(null)).subscribe(received => {
            ...
            it('should update a Assunto', () => {
                service.update(new Assunto(123)).subscribe(received => {
