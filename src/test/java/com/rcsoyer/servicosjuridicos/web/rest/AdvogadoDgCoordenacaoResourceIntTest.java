...
public class AdvogadoDgCoordenacaoResourceIntTest {
    ...
    private static final String DEFAULT_DG_PESSOAL_INICIO = "A";
    private static final String UPDATED_DG_PESSOAL_INICIO = "B";

    private static final String DEFAULT_DG_PESSOAL_FIM = "A";
    private static final String UPDATED_DG_PESSOAL_FIM = "B";

    private static final String DEFAULT_DG_DUPLA = "A";
    private static final String UPDATED_DG_DUPLA = "B";
    ...
    public void setup() {
        ...
        final AdvogadoDgCoordenacaoResource advogadoDgCoordenacaoResource = new AdvogadoDgCoordenacaoResource(advogadoDgCoordenacaoService);
    ...
    public void createAdvogadoDgCoordenacao() throws Exception {
        ...
        restAdvogadoDgCoordenacaoMockMvc.perform(post("/api/advogado-dg-coordenacaos")
            ...
            .content(TestUtil.convertObjectToJsonBytes(advogadoDgCoordenacaoDTO)))
        ...
        AdvogadoDgCoordenacao testAdvogadoDgCoordenacao = advogadoDgCoordenacaoList.get(advogadoDgCoordenacaoList.size() - 1);
    ...
    public void getAllAdvogadoDgCoordenacaos() throws Exception {
        ...
        restAdvogadoDgCoordenacaoMockMvc.perform(get("/api/advogado-dg-coordenacaos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(advogadoDgCoordenacao.getId().intValue())))
            .andExpect(jsonPath("$.[*].dgPessoalInicio").value(hasItem(DEFAULT_DG_PESSOAL_INICIO.toString())))
            .andExpect(jsonPath("$.[*].dgPessoalFim").value(hasItem(DEFAULT_DG_PESSOAL_FIM.toString())))
            .andExpect(jsonPath("$.[*].dgDupla").value(hasItem(DEFAULT_DG_DUPLA.toString())))
            .andExpect(jsonPath("$.[*].rangeDgCoordenacao").value(hasItem(DEFAULT_RANGE_DG_COORDENACAO.toString())));
    }
    ...
    public void getAdvogadoDgCoordenacao() throws Exception {
        ...
        restAdvogadoDgCoordenacaoMockMvc.perform(get("/api/advogado-dg-coordenacaos/{id}", advogadoDgCoordenacao.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void updateAdvogadoDgCoordenacao() throws Exception {
        ...
        AdvogadoDgCoordenacao updatedAdvogadoDgCoordenacao = advogadoDgCoordenacaoRepository.findById(advogadoDgCoordenacao.getId()).get();
        ...
        AdvogadoDgCoordenacaoDTO advogadoDgCoordenacaoDTO = advogadoDgCoordenacaoMapper.toDto(updatedAdvogadoDgCoordenacao);
    ...
    public void deleteAdvogadoDgCoordenacao() throws Exception {
        ...
        // Get the advogadoDgCoordenacao
        restAdvogadoDgCoordenacaoMockMvc.perform(delete("/api/advogado-dg-coordenacaos/{id}", advogadoDgCoordenacao.getId())
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(AdvogadoDgCoordenacao.class);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(AdvogadoDgCoordenacaoDTO.class);
